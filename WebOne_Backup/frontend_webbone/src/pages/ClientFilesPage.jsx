...
function ClientFilesPage({ level = 'project' }) {
  ...
  let filteredFolders = folders.filter(f => f.toLowerCase().includes(search.toLowerCase()));
  if (sort === "name") {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredFolders.map((folder, index) => (
            <div key={index} 
              ...
              className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer border border-slate-200 hover:border-blue-300">
              <div className="px-4 py-5 sm:p-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-medium text-slate-900 capitalize">{folder}</h3>
                <p className="mt-1 text-sm text-slate-500">View {folder}</p>
