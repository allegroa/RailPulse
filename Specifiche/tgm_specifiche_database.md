...
* **Cartella Database principale**: `E:/Software/RailPulse/DATABASE/TGM/`
...
Ogni sessione di rilievo è contenuta in una directory dedicata sotto la radice `DATABASE/TGM/`, denominata secondo il seguente pattern:
...
Nella directory principale `DATABASE/TGM/` risiedono dei file JSON ausiliari che svolgono il ruolo di tabelle di configurazione o tabelle di annotazione:
...
* **Percorso**: `DATABASE/TGM/tolerances_db.json`
...
* **Percorso**: `DATABASE/TGM/[Nome_Sessione]_db.json` (es. `2026-06-09_Padova_Milano_db.json`)
