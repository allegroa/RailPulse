# 🚀 PROMPT DI RIAVVIO PROGETTO — WebOne / RailPulse (P2604)
...
Sei un AI agente che deve riprendere lo sviluppo del progetto **WebOne / RailPulse** (codice P2604).

### Contesto del Progetto

**WebOne** è un'interfaccia web per la gestione, analisi e visualizzazione di dati di geometria ferroviaria. Nome commerciale: **RailPulse**. Il codice sorgente è su Google Drive nella cartella del progetto, ma deve essere **copiato su un path locale** (es. `D:\004_Software\WebOne\`) prima di eseguirlo, perché Node.js non funziona correttamente su percorsi Google Drive (UNC path incompatibili).
...
robocopy "D:\004_Software\WebOne" "G:\Il mio Drive\GESTIONE TITS\99_PROGETTI\P2604 - RailPulse\WebOne" /MIR /XD node_modules .git dist /R:1 /W:1 /NP /MT:8

# Sincronizza da Google Drive → PC locale (nuovo PC)
robocopy "G:\Il mio Drive\GESTIONE TITS\99_PROGETTI\P2604 - RailPulse\WebOne" "D:\004_Software\WebOne" /MIR /XD node_modules .git dist /R:1 /W:1 /NP /MT:8
```
