 ...
 */
async function getMaintenanceRecords(basePath) {
 ...
 */
async function addMaintenanceRecord(basePath, record) {
  const filePath = getMaintenanceFilePath(basePath);
 ...
 */
async function updateMaintenanceRecord(basePath, id, updatedFields) {
  const filePath = getMaintenanceFilePath(basePath);
  const records = await getMaintenanceRecords(basePath);
 ...
 */
async function deleteMaintenanceRecord(basePath, id) {
  const filePath = getMaintenanceFilePath(basePath);
